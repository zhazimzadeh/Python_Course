...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(425, 142)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.txt_input = QLineEdit(self.centralwidget)
        self.txt_input.setObjectName(u"txt_input")
        self.txt_input.setGeometry(QRect(300, 10, 113, 22))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(18, 10, 271, 20))
        ...
        self.btn_Check.setGeometry(QRect(150, 40, 111, 24))
        self.btn_Check.setStyleSheet(u"background-color: rgb(78, 234, 0);")
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(20, 110, 271, 20))
        ...
        self.lbl_remain.setGeometry(QRect(250, 110, 271, 20))
        self.lbl_remain.setStyleSheet(u"font: 700 12pt \"Segoe UI\";\n"
"color: rgb(0, 85, 255);")
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(20, 80, 51, 20))
        ...
        self.lbl_help.setGeometry(QRect(70, 80, 351, 20))
